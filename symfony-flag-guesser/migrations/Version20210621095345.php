 ...
 */
final class Version20210621095345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE to_the_quiz DROP score_answer');
        $this->addSql('ALTER TABLE to_the_quiz RENAME INDEX to_the_quiz_games0_fk TO IDX_5F143F52A80B2D8E');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE to_the_quiz ADD score_answer INT NOT NULL');
        $this->addSql('ALTER TABLE to_the_quiz RENAME INDEX idx_5f143f52a80b2d8e TO to_the_quiz_Games0_FK');
    }
}
